...
const categoryMeta: Record<string, { sub: string; desc: string }> = {
  "B2B UX Service": {
    sub: "복잡한 도메인을 단순하게",
    desc: "대시보드·디자인 시스템·서비스 설계까지, 복잡한 B2B 데이터를 명료한 구조로 푸는 프로젝트",
  },
  "B2C UX Service": {
    sub: "끝까지 남는 경험",
    desc: "학습 지속성과 전환율을 끌어올리는, 사용자 동기 중심의 B2C 서비스 프로젝트",
  },
  "Web Service": {
    sub: "브라우저에서 완결되는 흐름",
    desc: "랜딩부터 전환까지 한 페이지에서 끝나는 웹 서비스 프로젝트",
  },
  "UX Planning/Branding": {
    sub: "화면 이전의 설계",
    desc: "문제 정의와 브랜드 톤부터 잡는, 기획·브랜딩 중심 프로젝트",
  },
};
