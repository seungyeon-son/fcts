...
const diffCards = [
  {
    ...
    title: "목표 지표를\n먼저 정의합니다",
    desc: "기획서를 받으면 KPI를 먼저 찾습니다. 어떤 숫자를 움직여야 하는지 정의된 후 설계를 시작합니다.",
  ...
  },
  {
    ...
    title: "디자인 언어를 시스템화 합니다",
    desc: "컴포넌트, 토큰, 운영 원칙까지 포함한 디자인 시스템을 설계합니다. 구조를 먼저 생각합니다.",
  ...
  return (
    <>
      ...
      <section style={{ padding: "80px 0" }}>
        <Container>
          <SectionTitle>일하는 방식</SectionTitle>
      ...
      <section style={{ padding: "80px 0" }}>
        <Container>
          <SectionTitle>디자인 프로세스</SectionTitle>
      ...
      <section style={{ background: theme.colors.gray100, padding: "80px 0" }}>
        <Container>
          <SectionTitle style={{ marginBottom: "8px" }}>프로젝트</SectionTitle>
      ...
      <section style={{ padding: "80px 0" }}>
        <Container>
          <CtaBlock>
            ...
            <CtaTitle>{"복잡성을 단순함으로 바꾸고 \n비즈니스에 질서를 확립합니다.."}</CtaTitle>
            <CtaDesc>
              저는 복잡함을 덜어내, 사용자의 판단과 비즈니스 목표가 같은 방향을 보게 만듭니다.
              <br />
              모든 결정에는 이유가 있고, 그 이유가 화면을 명료하게 만듭니다.
            </CtaDesc>
          </CtaBlock>
        </Container>
      </section>
